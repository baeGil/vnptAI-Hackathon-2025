...
2. MATH
   ...
   - **TIÊU CHÍ BẮT BUỘC ĐỂ LÀ MATH:**
        ...
        (b) HOẶC cần SUY LUẬN/PHÂN TÍCH quan hệ giữa các đại lượng (so sánh, đánh giá xu hướng tăng/giảm, phân tích hành vi nghiệm của phương trình).
        (c) HOẶC có số liệu cụ thể và cần xác định kết quả dựa trên mối quan hệ toán học.
3. READING
